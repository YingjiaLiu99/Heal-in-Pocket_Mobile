...
const RadioMutipleChoiceCenter = ({ options, onSelectionChange, upperLabel }) => {
...
const styles = StyleSheet.create({
    ...
    // If want to set all to the left you should use
...
export default RadioMutipleChoiceCenter;